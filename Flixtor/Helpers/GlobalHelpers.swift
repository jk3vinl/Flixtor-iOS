...
let exampleEpisodeInfo1 = CurrentEpisodeInfo(episodeName: "Bsdfgsdsg and Esdgsgsd", description: "Ssdfhk sdg sdjksdfg sdg sdfgsd, sdgsdg srsaaarge. Ifdgh dghd, dfghdf dfhw fasjfb yjbfd sfcvgc fjnh.", season: 1, episode: 1)
